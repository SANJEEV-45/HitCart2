...
<body>
    <!-- navbar -->
    <nav class="navbar navbar-expand-md d-flex flex-row  " id="navbar">
        <!-- Brand -->
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{route('product.category',['category_id'=>7])}}">SmartPhones</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li>
                   <form class="form-inline d-flex flex-row" style="margin-left: 3rem">
                       <input class="form-control mr-sm-4" style="width: 25rem" type="search" placeholder="Search for products" aria-label="Search">
                       <button class="btn btn-outline-dark   my-8 my-sm-0 " type="submit">Search</button>
                   </form>
                </li>
            </ul>
        </div>
