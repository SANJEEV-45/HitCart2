    ...
    <div class="card mb-3" style="max-width:70%; margin:2% auto;">      
        <div class="row g-0">
            <div class="col-md-4 mt-5">
                <img src="{{asset("images/{$data['image']}")}}" class="img-fluid rounded-start" alt="..." loading="lazy">
            </div>
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <hr>
                    <h3 style="display: inline;"><small class=" text-danger">-{{$data['discount']}}%&nbsp;</small></h3>
                      @php
                           $price = $data['list_price'];
                           $discount = $data['discount'] / 100;
                          $total = $price -($price * $discount);
                      @endphp
                    <h3 class="fw-bold" style="display: inline;"><small class="text-success">Rs.&nbsp;{{$total}}</small></h3><br>
