            ...
            <div class="col">
                <div class="card h-100 mt-4" style="cursor: pointer">
                    <a href="{{ route('product.view', ['product_id' => $product['id']]) }}" class="text-decoration-none ">
                        <img src="{{ asset("images/{$product['image']}") }}" loading="lazy" class="card-img-top mt-3" alt="...">
                        <div class="card-body text-black">
                            <h5 class="card-title text-decoration-none mt-0 text-decoration-none">{{ $product['name'] }}
                            </h5>
                            ...
                            <h6>List Price :<small
                                ...
                                <p><small class="px-lg-2 pt-1 pb-1" style="background-color: rgb(12, 181, 12);">Save
                                        {{ $product['discount'] }}%</small>&nbsp;with coupon (some size/colors)</p>
                        </div>
                    </a>
                </div>
            </div>
